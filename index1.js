 ...
 */
 function typewrite()
 {
     let str="<我愿意为一个人，写满整个世界的情诗<因为我喜欢她，因为......我也想给她哪怕一点点的浪漫<因为我喜欢你，因为那个人就是你！<小吴小吴，超喜欢你！！ㄟ(≧◇≦)ㄏ<你知道吗，当代码不止是代码的时候，它就有了新的意义。<";//利用<作为换行符 -作为空格
     let strp="";
     let i=0;
     function print1()
     {	
...
let clickb=false;//判断播放按钮是否已经按过了，如果已经按过了才可以执行键盘事件
 ...
 let a=[
     ...
     {name:"L" ,yin:3, str:"<br><br><br><br>世界上美好的东西不太多,<br><br>立秋傍晚从河对岸吹来的风,<br><br>和二十来岁笑起来要人命的你。"},
     {name:"M" ,yin:13, str:"<br><br><br><br>“在青山绿水之间，我想牵着你的手，<br></br>走过这座桥，桥上是绿叶红花，<br><br>桥下是流水人家，桥的那头是青丝，桥的这头是白发。”"},
     {name:"N" ,yin:3, str:"<br><br><br><br>月亮照回湖心<br><br>野鹤奔向闲云<br><br>我步入你<br><br>小吴小吴，超喜欢你！！！"},
     ...
     {name:"Q" ,yin:17, str:"<br><br><br><br>那天微风不燥，<br><br>阳光正好，<br><br>我抱着你，就像抱着全世界。"},
     ...
     {name:"W" ,yin:8, str:"<br><br><br><br>你一眨眼，温驯的小鹿有跳动一下，<br><br>柔软的暖风有轻拂一下，遥远的星星有闪烁一下，<br><br>我也有心动，却不止一下。"},
 ...
 function fl(e)
 {
     ...
     if((key<='z'&&key>='a')||(key<='Z'&&key>='A'))//避免大小写的错误
     {
         ...
         if(s.indexOf("XIAOWUXIAOWUCXHN")!=-1&&records==0)
         {
